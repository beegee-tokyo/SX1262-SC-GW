...
//
// Note: disable sensors not used in defines.h
...
nodex nodes[2] = {
	{0x260211CE, "esp32r"}, // F=0
	{0x260214FE, "esp8266"} // F=0
};
#endif
...
unsigned char DevAddr[4] = _DEVADDR; // see defines.h
...
int sensorPacket()
{
	...
	{
		if (debug > 0)
			Serial.println(F("sensorPacket:: ERROR buffer size too large"));
		return (-1);
	}
